  ...
  const loadAssignedListings = async () => {
    ...
    try {
      ...
      const mappedListings = (data || []).map((l: any) => ({
        ...
        images: l.images || [],
        // Check metadata for license document. Mongoose Map might be object in JSON.
        license_document_url: l.metadata?.license_document,
        profiles: {
                        ...
                        <div className="space-y-3">
                          ...
                          {listing.license_document_url ? (
                            ...
                            <div className="p-4 border border-dashed rounded-lg text-center text-muted-foreground text-sm">
                              No license document found for this listing.
                            </div>
                          )}
                        </div>
                      </div>
